    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        >
          ...
          >
            <MaterialIcons name="storefront" size={40} color={theme.colors.background} />
          </LinearGradient>
          <Text style={styles.appName}>Gaon Zaika</Text>
          <Text style={styles.slogan}>Premium Partner Portal</Text>
        </MotiView>
        ...
        >
          <Text style={styles.authTitle}>
            {isLogin ? 'Welcome Partner.' : 'Join the Elite.'}
          </Text>
          <Text style={styles.authSubtitle}>
            {isLogin 
              ? 'Sign in to manage your luxury restaurant operations' 
              : 'Register to become a premium culinary partner'
            }
          </Text>
          ...
          <View style={styles.form}>
            ...
            >
              ...
              <Text style={styles.authButtonText}>
                {loading ? 'Processing...' : (isLogin ? 'AUTHORIZE' : 'APPLY AS PARTNER')}
              </Text>
            </TouchableOpacity>
          </View>
